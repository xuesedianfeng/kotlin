...
/**
 * Single script diagnostic report
...
sealed class ResultWithDiagnostics<out R> {
    ...
    /**
     * Successful [value] result with optional [reports] with diagnostics
     */
...
/**
 * Chain actions on successful result:
