...
/**
 * Base class for scripting host implementations
 */
abstract class BasicScriptingHost(
    ...
    /**
     * overridable wrapper for executing evaluation in a desired coroutines context
     */
    open fun <T> runInCoroutineContext(block: suspend CoroutineScope.() -> T): T = runBlocking { block() }

    /**
     * default implementation of the evaluation function
     */
    open fun eval(
        script: SourceCode,
