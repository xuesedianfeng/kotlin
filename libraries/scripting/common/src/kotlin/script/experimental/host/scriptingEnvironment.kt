...
/**
 * A pointer to the generic "class loader" for the types used in the script configurations
 */
val ScriptingHostConfigurationKeys.getScriptingClass by PropertiesCollection.key<GetScriptingClass>()

/**
 * An interface to the generic "class loader" for the types used in the script configurations
 */
