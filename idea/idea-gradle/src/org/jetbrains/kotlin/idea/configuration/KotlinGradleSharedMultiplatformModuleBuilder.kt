...
class KotlinGradleSharedMultiplatformModuleBuilder : KotlinGradleAbstractMultiplatformModuleBuilder() {
    ...
    override fun getPresentableName() = "Kotlin (Multiplatform - Shared)"

    override fun getDescription() =
        "Multiplatform projects allow sharing the same code between all three main platforms (JVM, JS, Native) supported by Kotlin. " +
                "Such projects are built with Gradle."
