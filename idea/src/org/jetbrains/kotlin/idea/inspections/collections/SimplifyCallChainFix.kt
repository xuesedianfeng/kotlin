...
class SimplifyCallChainFix(private val newCallText: String) : LocalQuickFix {
    ...
    override fun applyFix(project: Project, descriptor: ProblemDescriptor) {
        (descriptor.psiElement as? KtQualifiedExpression)?.let { secondQualifiedExpression ->
            ...
            fun KtValueArgumentList.getTextInsideBrackets(): String {
                val inBracketsRange = PsiChildRange(leftParenthesis?.nextSibling ?: firstChild, rightParenthesis?.prevSibling ?: lastChild)
                return inBracketsRange.joinToString(separator = "") { it.text }
            }
            ...
            val argumentsText = listOfNotNull(
                ...
                if (it.isEmpty()) ""
                    ...
                    callArgumentList.getTextInsideBrackets()
                }
            }
